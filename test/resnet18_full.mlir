func.func @resnet18(
  ...
  } ins(%pad12, %w_l1_b0_c1 : tensor<1x64x58x58xf16>, tensor<64x64x3x3xf16>)
  ...
  %conv21 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad18, %w_l1_b0_c2 : tensor<1x64x58x58xf16>, tensor<64x64x3x3xf16>)
  ...
  %conv29 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad26, %w_l1_b1_c1 : tensor<1x64x58x58xf16>, tensor<64x64x3x3xf16>)
  ...
  %conv35 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad32, %w_l1_b1_c2 : tensor<1x64x58x58xf16>, tensor<64x64x3x3xf16>)
  ...
  %conv43 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<2> : tensor<2xi64>
  } ins(%pad40, %w_l2_b0_c1 : tensor<1x64x58x58xf16>, tensor<128x64x3x3xf16>)
  ...
  %conv49 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad46, %w_l2_b0_c2 : tensor<1x128x30x30xf16>, tensor<128x128x3x3xf16>)
    outs(%fill48 : tensor<1x128x28x28xf16>) -> tensor<1x128x28x28xf16>
  // 1x1 stride-2 shortcut conv
  ...
  %conv52 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<2> : tensor<2xi64>
  } ins(%relu39, %w_l2_b0_sc : tensor<1x64x56x56xf16>, tensor<128x64x1x1xf16>)
  ...
  %conv60 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad57, %w_l2_b1_c1 : tensor<1x128x30x30xf16>, tensor<128x128x3x3xf16>)
  ...
  %conv66 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad63, %w_l2_b1_c2 : tensor<1x128x30x30xf16>, tensor<128x128x3x3xf16>)
  ...
  %conv74 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<2> : tensor<2xi64>
  } ins(%pad71, %w_l3_b0_c1 : tensor<1x128x30x30xf16>, tensor<256x128x3x3xf16>)
  ...
  %conv80 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad77, %w_l3_b0_c2 : tensor<1x256x16x16xf16>, tensor<256x256x3x3xf16>)
  ...
  %conv83 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<2> : tensor<2xi64>
  } ins(%relu70, %w_l3_b0_sc : tensor<1x128x28x28xf16>, tensor<256x128x1x1xf16>)
  ...
  %conv91 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad88, %w_l3_b1_c1 : tensor<1x256x16x16xf16>, tensor<256x256x3x3xf16>)
  ...
  %conv97 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad94, %w_l3_b1_c2 : tensor<1x256x16x16xf16>, tensor<256x256x3x3xf16>)
  ...
  %conv105 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<2> : tensor<2xi64>
  } ins(%pad102, %w_l4_b0_c1 : tensor<1x256x16x16xf16>, tensor<512x256x3x3xf16>)
  ...
  %conv111 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad108, %w_l4_b0_c2 : tensor<1x512x9x9xf16>, tensor<512x512x3x3xf16>)
  ...
  %conv114 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<2> : tensor<2xi64>
  } ins(%relu101, %w_l4_b0_sc : tensor<1x256x14x14xf16>, tensor<512x256x1x1xf16>)
  ...
  %conv122 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad119, %w_l4_b1_c1 : tensor<1x512x9x9xf16>, tensor<512x512x3x3xf16>)
  ...
  %conv128 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad125, %w_l4_b1_c2 : tensor<1x512x9x9xf16>, tensor<512x512x3x3xf16>)
  ...
  // FC modeled as 7x7 conv: [1,512,7,7] -> [1,1000,1,1]
