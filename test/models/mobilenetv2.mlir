func.func @mobilenetv2(
    ...
    %w_blk6_exp: tensor<192x32x1x1xf16>,
    %w_blk6_dw: tensor<192x192x3x3xf16>,
    %w_blk6_proj: tensor<64x192x1x1xf16>,
    %w_blk7_exp: tensor<384x64x1x1xf16>,
    %w_blk7_dw: tensor<384x384x3x3xf16>,
    %w_blk7_proj: tensor<64x384x1x1xf16>,
    %w_blk8_exp: tensor<384x64x1x1xf16>,
    %w_blk8_dw: tensor<384x384x3x3xf16>,
    %w_blk8_proj: tensor<64x384x1x1xf16>,
    %w_blk9_exp: tensor<384x64x1x1xf16>,
    %w_blk9_dw: tensor<384x384x3x3xf16>,
    %w_blk9_proj: tensor<64x384x1x1xf16>,
    %w_blk10_exp: tensor<384x64x1x1xf16>,
    %w_blk10_dw: tensor<384x384x3x3xf16>,
    %w_blk10_proj: tensor<96x384x1x1xf16>,
    ...
    %w_blk12_proj: tensor<96x576x1x1xf16>,
    %w_blk13_exp: tensor<576x96x1x1xf16>,
    %w_blk13_dw: tensor<576x576x3x3xf16>,
    %w_blk13_proj: tensor<160x576x1x1xf16>,
    %w_blk14_exp: tensor<960x160x1x1xf16>,
    %w_blk14_dw: tensor<960x960x3x3xf16>,
    %w_blk14_proj: tensor<160x960x1x1xf16>,
    %w_blk15_exp: tensor<960x160x1x1xf16>,
    %w_blk15_dw: tensor<960x960x3x3xf16>,
    %w_blk15_proj: tensor<160x960x1x1xf16>,
    %w_blk16_exp: tensor<960x160x1x1xf16>,
    %w_blk16_dw: tensor<960x960x3x3xf16>,
    %w_blk16_proj: tensor<320x960x1x1xf16>,
  ...
  // IRB 1: 16->24 mid=96 s=2 112x112
  ...
  // IRB 6: 32->64 mid=192 s=2 28x28
  %init91 = tensor.empty() : tensor<1x192x28x28xf16>
  %fill92 = linalg.fill ins(%cst : f16) outs(%init91 : tensor<1x192x28x28xf16>) -> tensor<1x192x28x28xf16>
  %conv93 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%add90, %w_blk6_exp : tensor<1x32x28x28xf16>, tensor<192x32x1x1xf16>)
    outs(%fill92 : tensor<1x192x28x28xf16>) -> tensor<1x192x28x28xf16>
  %empty94 = tensor.empty() : tensor<1x192x28x28xf16>
  %relu95 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv93 : tensor<1x192x28x28xf16>)
    outs(%empty94 : tensor<1x192x28x28xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init97 = tensor.empty() : tensor<1x192x14x14xf16>
  %fill98 = linalg.fill ins(%cst : f16) outs(%init97 : tensor<1x192x14x14xf16>) -> tensor<1x192x14x14xf16>
  %conv99 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<2> : tensor<2xi64>
  } ins(%pad96, %w_blk6_dw : tensor<1x192x30x30xf16>, tensor<192x192x3x3xf16>)
    outs(%fill98 : tensor<1x192x14x14xf16>) -> tensor<1x192x14x14xf16>
  %empty100 = tensor.empty() : tensor<1x192x14x14xf16>
  %relu101 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv99 : tensor<1x192x14x14xf16>)
    outs(%empty100 : tensor<1x192x14x14xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x192x14x14xf16>
  %init102 = tensor.empty() : tensor<1x64x14x14xf16>
  %fill103 = linalg.fill ins(%cst : f16) outs(%init102 : tensor<1x64x14x14xf16>) -> tensor<1x64x14x14xf16>
  %conv104 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu101, %w_blk6_proj : tensor<1x192x14x14xf16>, tensor<64x192x1x1xf16>)
    outs(%fill103 : tensor<1x64x14x14xf16>) -> tensor<1x64x14x14xf16>

  // IRB 7: 64->64 mid=384 s=1 14x14
  %init105 = tensor.empty() : tensor<1x384x14x14xf16>
  %fill106 = linalg.fill ins(%cst : f16) outs(%init105 : tensor<1x384x14x14xf16>) -> tensor<1x384x14x14xf16>
  %conv107 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%conv104, %w_blk7_exp : tensor<1x64x14x14xf16>, tensor<384x64x1x1xf16>)
    outs(%fill106 : tensor<1x384x14x14xf16>) -> tensor<1x384x14x14xf16>
  %empty108 = tensor.empty() : tensor<1x384x14x14xf16>
  %relu109 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv107 : tensor<1x384x14x14xf16>)
    outs(%empty108 : tensor<1x384x14x14xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init111 = tensor.empty() : tensor<1x384x14x14xf16>
  %fill112 = linalg.fill ins(%cst : f16) outs(%init111 : tensor<1x384x14x14xf16>) -> tensor<1x384x14x14xf16>
  %conv113 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad110, %w_blk7_dw : tensor<1x384x16x16xf16>, tensor<384x384x3x3xf16>)
    outs(%fill112 : tensor<1x384x14x14xf16>) -> tensor<1x384x14x14xf16>
  %empty114 = tensor.empty() : tensor<1x384x14x14xf16>
  %relu115 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv113 : tensor<1x384x14x14xf16>)
    outs(%empty114 : tensor<1x384x14x14xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x384x14x14xf16>
  %init116 = tensor.empty() : tensor<1x64x14x14xf16>
  %fill117 = linalg.fill ins(%cst : f16) outs(%init116 : tensor<1x64x14x14xf16>) -> tensor<1x64x14x14xf16>
  %conv118 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu115, %w_blk7_proj : tensor<1x384x14x14xf16>, tensor<64x384x1x1xf16>)
    outs(%fill117 : tensor<1x64x14x14xf16>) -> tensor<1x64x14x14xf16>
  %empty119 = tensor.empty() : tensor<1x64x14x14xf16>
  %add120 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv118, %conv104 : tensor<1x64x14x14xf16>, tensor<1x64x14x14xf16>)
    outs(%empty119 : tensor<1x64x14x14xf16>) {
  ^bb0(%a: f16, %b: f16, %out: f16):
    %sum = arith.addf %a, %b : f16
    linalg.yield %sum : f16
  } -> tensor<1x64x14x14xf16>

  // IRB 8: 64->64 mid=384 s=1 14x14
  %init121 = tensor.empty() : tensor<1x384x14x14xf16>
  %fill122 = linalg.fill ins(%cst : f16) outs(%init121 : tensor<1x384x14x14xf16>) -> tensor<1x384x14x14xf16>
  %conv123 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%add120, %w_blk8_exp : tensor<1x64x14x14xf16>, tensor<384x64x1x1xf16>)
    outs(%fill122 : tensor<1x384x14x14xf16>) -> tensor<1x384x14x14xf16>
  %empty124 = tensor.empty() : tensor<1x384x14x14xf16>
  %relu125 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv123 : tensor<1x384x14x14xf16>)
    outs(%empty124 : tensor<1x384x14x14xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init127 = tensor.empty() : tensor<1x384x14x14xf16>
  %fill128 = linalg.fill ins(%cst : f16) outs(%init127 : tensor<1x384x14x14xf16>) -> tensor<1x384x14x14xf16>
  %conv129 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad126, %w_blk8_dw : tensor<1x384x16x16xf16>, tensor<384x384x3x3xf16>)
    outs(%fill128 : tensor<1x384x14x14xf16>) -> tensor<1x384x14x14xf16>
  %empty130 = tensor.empty() : tensor<1x384x14x14xf16>
  %relu131 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv129 : tensor<1x384x14x14xf16>)
    outs(%empty130 : tensor<1x384x14x14xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x384x14x14xf16>
  %init132 = tensor.empty() : tensor<1x64x14x14xf16>
  %fill133 = linalg.fill ins(%cst : f16) outs(%init132 : tensor<1x64x14x14xf16>) -> tensor<1x64x14x14xf16>
  %conv134 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu131, %w_blk8_proj : tensor<1x384x14x14xf16>, tensor<64x384x1x1xf16>)
    outs(%fill133 : tensor<1x64x14x14xf16>) -> tensor<1x64x14x14xf16>
  %empty135 = tensor.empty() : tensor<1x64x14x14xf16>
  %add136 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv134, %add120 : tensor<1x64x14x14xf16>, tensor<1x64x14x14xf16>)
    outs(%empty135 : tensor<1x64x14x14xf16>) {
  ^bb0(%a: f16, %b: f16, %out: f16):
    %sum = arith.addf %a, %b : f16
    linalg.yield %sum : f16
  } -> tensor<1x64x14x14xf16>

  // IRB 9: 64->64 mid=384 s=1 14x14
  %init137 = tensor.empty() : tensor<1x384x14x14xf16>
  %fill138 = linalg.fill ins(%cst : f16) outs(%init137 : tensor<1x384x14x14xf16>) -> tensor<1x384x14x14xf16>
  %conv139 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%add136, %w_blk9_exp : tensor<1x64x14x14xf16>, tensor<384x64x1x1xf16>)
    outs(%fill138 : tensor<1x384x14x14xf16>) -> tensor<1x384x14x14xf16>
  %empty140 = tensor.empty() : tensor<1x384x14x14xf16>
  %relu141 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv139 : tensor<1x384x14x14xf16>)
    outs(%empty140 : tensor<1x384x14x14xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init143 = tensor.empty() : tensor<1x384x14x14xf16>
  %fill144 = linalg.fill ins(%cst : f16) outs(%init143 : tensor<1x384x14x14xf16>) -> tensor<1x384x14x14xf16>
  %conv145 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad142, %w_blk9_dw : tensor<1x384x16x16xf16>, tensor<384x384x3x3xf16>)
    outs(%fill144 : tensor<1x384x14x14xf16>) -> tensor<1x384x14x14xf16>
  %empty146 = tensor.empty() : tensor<1x384x14x14xf16>
  %relu147 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv145 : tensor<1x384x14x14xf16>)
    outs(%empty146 : tensor<1x384x14x14xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x384x14x14xf16>
  %init148 = tensor.empty() : tensor<1x64x14x14xf16>
  %fill149 = linalg.fill ins(%cst : f16) outs(%init148 : tensor<1x64x14x14xf16>) -> tensor<1x64x14x14xf16>
  %conv150 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu147, %w_blk9_proj : tensor<1x384x14x14xf16>, tensor<64x384x1x1xf16>)
    outs(%fill149 : tensor<1x64x14x14xf16>) -> tensor<1x64x14x14xf16>
  %empty151 = tensor.empty() : tensor<1x64x14x14xf16>
  %add152 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv150, %add136 : tensor<1x64x14x14xf16>, tensor<1x64x14x14xf16>)
    outs(%empty151 : tensor<1x64x14x14xf16>) {
  ^bb0(%a: f16, %b: f16, %out: f16):
    %sum = arith.addf %a, %b : f16
    linalg.yield %sum : f16
  } -> tensor<1x64x14x14xf16>

  // IRB 10: 64->96 mid=384 s=1 14x14
  %init153 = tensor.empty() : tensor<1x384x14x14xf16>
  %fill154 = linalg.fill ins(%cst : f16) outs(%init153 : tensor<1x384x14x14xf16>) -> tensor<1x384x14x14xf16>
  %conv155 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%add152, %w_blk10_exp : tensor<1x64x14x14xf16>, tensor<384x64x1x1xf16>)
    outs(%fill154 : tensor<1x384x14x14xf16>) -> tensor<1x384x14x14xf16>
  %empty156 = tensor.empty() : tensor<1x384x14x14xf16>
  %relu157 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv155 : tensor<1x384x14x14xf16>)
    outs(%empty156 : tensor<1x384x14x14xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init159 = tensor.empty() : tensor<1x384x14x14xf16>
  %fill160 = linalg.fill ins(%cst : f16) outs(%init159 : tensor<1x384x14x14xf16>) -> tensor<1x384x14x14xf16>
  %conv161 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad158, %w_blk10_dw : tensor<1x384x16x16xf16>, tensor<384x384x3x3xf16>)
    outs(%fill160 : tensor<1x384x14x14xf16>) -> tensor<1x384x14x14xf16>
  %empty162 = tensor.empty() : tensor<1x384x14x14xf16>
  %relu163 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv161 : tensor<1x384x14x14xf16>)
    outs(%empty162 : tensor<1x384x14x14xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %conv166 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu163, %w_blk10_proj : tensor<1x384x14x14xf16>, tensor<96x384x1x1xf16>)
  ...
  // IRB 12: 96->96 mid=576 s=1 14x14
  ...
  %init189 = tensor.empty() : tensor<1x576x14x14xf16>
  %fill190 = linalg.fill ins(%cst : f16) outs(%init189 : tensor<1x576x14x14xf16>) -> tensor<1x576x14x14xf16>
  %conv191 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad188, %w_blk12_dw : tensor<1x576x16x16xf16>, tensor<576x576x3x3xf16>)
    outs(%fill190 : tensor<1x576x14x14xf16>) -> tensor<1x576x14x14xf16>
  %empty192 = tensor.empty() : tensor<1x576x14x14xf16>
  %relu193 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv191 : tensor<1x576x14x14xf16>)
    outs(%empty192 : tensor<1x576x14x14xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x576x14x14xf16>
  %init194 = tensor.empty() : tensor<1x96x14x14xf16>
  %fill195 = linalg.fill ins(%cst : f16) outs(%init194 : tensor<1x96x14x14xf16>) -> tensor<1x96x14x14xf16>
  %conv196 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu193, %w_blk12_proj : tensor<1x576x14x14xf16>, tensor<96x576x1x1xf16>)
    outs(%fill195 : tensor<1x96x14x14xf16>) -> tensor<1x96x14x14xf16>
  %empty197 = tensor.empty() : tensor<1x96x14x14xf16>
  %add198 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv196, %add182 : tensor<1x96x14x14xf16>, tensor<1x96x14x14xf16>)
    outs(%empty197 : tensor<1x96x14x14xf16>) {
  ^bb0(%a: f16, %b: f16, %out: f16):
    %sum = arith.addf %a, %b : f16
    linalg.yield %sum : f16
  } -> tensor<1x96x14x14xf16>

  // IRB 13: 96->160 mid=576 s=2 14x14
  %init199 = tensor.empty() : tensor<1x576x14x14xf16>
  %fill200 = linalg.fill ins(%cst : f16) outs(%init199 : tensor<1x576x14x14xf16>) -> tensor<1x576x14x14xf16>
  %conv201 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%add198, %w_blk13_exp : tensor<1x96x14x14xf16>, tensor<576x96x1x1xf16>)
    outs(%fill200 : tensor<1x576x14x14xf16>) -> tensor<1x576x14x14xf16>
  %empty202 = tensor.empty() : tensor<1x576x14x14xf16>
  %relu203 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv201 : tensor<1x576x14x14xf16>)
    outs(%empty202 : tensor<1x576x14x14xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init205 = tensor.empty() : tensor<1x576x7x7xf16>
  %fill206 = linalg.fill ins(%cst : f16) outs(%init205 : tensor<1x576x7x7xf16>) -> tensor<1x576x7x7xf16>
  %conv207 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<2> : tensor<2xi64>
  } ins(%pad204, %w_blk13_dw : tensor<1x576x16x16xf16>, tensor<576x576x3x3xf16>)
    outs(%fill206 : tensor<1x576x7x7xf16>) -> tensor<1x576x7x7xf16>
  %empty208 = tensor.empty() : tensor<1x576x7x7xf16>
  %relu209 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv207 : tensor<1x576x7x7xf16>)
    outs(%empty208 : tensor<1x576x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %conv212 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu209, %w_blk13_proj : tensor<1x576x7x7xf16>, tensor<160x576x1x1xf16>)
    outs(%fill211 : tensor<1x160x7x7xf16>) -> tensor<1x160x7x7xf16>

  // IRB 14: 160->160 mid=960 s=1 7x7
  %init213 = tensor.empty() : tensor<1x960x7x7xf16>
  %fill214 = linalg.fill ins(%cst : f16) outs(%init213 : tensor<1x960x7x7xf16>) -> tensor<1x960x7x7xf16>
  %conv215 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%conv212, %w_blk14_exp : tensor<1x160x7x7xf16>, tensor<960x160x1x1xf16>)
    outs(%fill214 : tensor<1x960x7x7xf16>) -> tensor<1x960x7x7xf16>
  %empty216 = tensor.empty() : tensor<1x960x7x7xf16>
  %relu217 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv215 : tensor<1x960x7x7xf16>)
    outs(%empty216 : tensor<1x960x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init219 = tensor.empty() : tensor<1x960x7x7xf16>
  %fill220 = linalg.fill ins(%cst : f16) outs(%init219 : tensor<1x960x7x7xf16>) -> tensor<1x960x7x7xf16>
  %conv221 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad218, %w_blk14_dw : tensor<1x960x9x9xf16>, tensor<960x960x3x3xf16>)
    outs(%fill220 : tensor<1x960x7x7xf16>) -> tensor<1x960x7x7xf16>
  %empty222 = tensor.empty() : tensor<1x960x7x7xf16>
  %relu223 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv221 : tensor<1x960x7x7xf16>)
    outs(%empty222 : tensor<1x960x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x960x7x7xf16>
  %init224 = tensor.empty() : tensor<1x160x7x7xf16>
  %fill225 = linalg.fill ins(%cst : f16) outs(%init224 : tensor<1x160x7x7xf16>) -> tensor<1x160x7x7xf16>
  %conv226 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu223, %w_blk14_proj : tensor<1x960x7x7xf16>, tensor<160x960x1x1xf16>)
    outs(%fill225 : tensor<1x160x7x7xf16>) -> tensor<1x160x7x7xf16>
  %empty227 = tensor.empty() : tensor<1x160x7x7xf16>
  %add228 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv226, %conv212 : tensor<1x160x7x7xf16>, tensor<1x160x7x7xf16>)
    outs(%empty227 : tensor<1x160x7x7xf16>) {
  ^bb0(%a: f16, %b: f16, %out: f16):
    %sum = arith.addf %a, %b : f16
    linalg.yield %sum : f16
  } -> tensor<1x160x7x7xf16>

  // IRB 15: 160->160 mid=960 s=1 7x7
  %init229 = tensor.empty() : tensor<1x960x7x7xf16>
  %fill230 = linalg.fill ins(%cst : f16) outs(%init229 : tensor<1x960x7x7xf16>) -> tensor<1x960x7x7xf16>
  %conv231 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%add228, %w_blk15_exp : tensor<1x160x7x7xf16>, tensor<960x160x1x1xf16>)
    outs(%fill230 : tensor<1x960x7x7xf16>) -> tensor<1x960x7x7xf16>
  %empty232 = tensor.empty() : tensor<1x960x7x7xf16>
  %relu233 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv231 : tensor<1x960x7x7xf16>)
    outs(%empty232 : tensor<1x960x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init235 = tensor.empty() : tensor<1x960x7x7xf16>
  %fill236 = linalg.fill ins(%cst : f16) outs(%init235 : tensor<1x960x7x7xf16>) -> tensor<1x960x7x7xf16>
  %conv237 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad234, %w_blk15_dw : tensor<1x960x9x9xf16>, tensor<960x960x3x3xf16>)
    outs(%fill236 : tensor<1x960x7x7xf16>) -> tensor<1x960x7x7xf16>
  %empty238 = tensor.empty() : tensor<1x960x7x7xf16>
  %relu239 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv237 : tensor<1x960x7x7xf16>)
    outs(%empty238 : tensor<1x960x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x960x7x7xf16>
  %init240 = tensor.empty() : tensor<1x160x7x7xf16>
  %fill241 = linalg.fill ins(%cst : f16) outs(%init240 : tensor<1x160x7x7xf16>) -> tensor<1x160x7x7xf16>
  %conv242 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu239, %w_blk15_proj : tensor<1x960x7x7xf16>, tensor<160x960x1x1xf16>)
    outs(%fill241 : tensor<1x160x7x7xf16>) -> tensor<1x160x7x7xf16>
  %empty243 = tensor.empty() : tensor<1x160x7x7xf16>
  %add244 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv242, %add228 : tensor<1x160x7x7xf16>, tensor<1x160x7x7xf16>)
    outs(%empty243 : tensor<1x160x7x7xf16>) {
  ^bb0(%a: f16, %b: f16, %out: f16):
    %sum = arith.addf %a, %b : f16
    linalg.yield %sum : f16
  } -> tensor<1x160x7x7xf16>

  // IRB 16: 160->320 mid=960 s=1 7x7
  %init245 = tensor.empty() : tensor<1x960x7x7xf16>
  %fill246 = linalg.fill ins(%cst : f16) outs(%init245 : tensor<1x960x7x7xf16>) -> tensor<1x960x7x7xf16>
  %conv247 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%add244, %w_blk16_exp : tensor<1x160x7x7xf16>, tensor<960x160x1x1xf16>)
    outs(%fill246 : tensor<1x960x7x7xf16>) -> tensor<1x960x7x7xf16>
  %empty248 = tensor.empty() : tensor<1x960x7x7xf16>
  %relu249 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv247 : tensor<1x960x7x7xf16>)
    outs(%empty248 : tensor<1x960x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init251 = tensor.empty() : tensor<1x960x7x7xf16>
  %fill252 = linalg.fill ins(%cst : f16) outs(%init251 : tensor<1x960x7x7xf16>) -> tensor<1x960x7x7xf16>
  %conv253 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad250, %w_blk16_dw : tensor<1x960x9x9xf16>, tensor<960x960x3x3xf16>)
    outs(%fill252 : tensor<1x960x7x7xf16>) -> tensor<1x960x7x7xf16>
  %empty254 = tensor.empty() : tensor<1x960x7x7xf16>
  %relu255 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv253 : tensor<1x960x7x7xf16>)
    outs(%empty254 : tensor<1x960x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %conv258 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu255, %w_blk16_proj : tensor<1x960x7x7xf16>, tensor<320x960x1x1xf16>)
