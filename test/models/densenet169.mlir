func.func @densenet169(
  ...
  %init584 = tensor.empty() : tensor<1x32x14x14xf16>
  %fill585 = linalg.fill ins(%cst : f16) outs(%init584 : tensor<1x32x14x14xf16>) -> tensor<1x32x14x14xf16>
  %conv586 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu583, %w_t2_conv : tensor<1x32x14x14xf16>, tensor<32x32x1x1xf16>)
    outs(%fill585 : tensor<1x32x14x14xf16>) -> tensor<1x32x14x14xf16>
  %empty587 = tensor.empty() : tensor<1x32x14x14xf16>
  %relu588 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv586 : tensor<1x32x14x14xf16>)
    outs(%empty587 : tensor<1x32x14x14xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %conv592 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<2> : tensor<2xi64>
  } ins(%pad589, %w_t2_pool : tensor<1x32x16x16xf16>, tensor<32x32x3x3xf16>)
  ...
  %conv597 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu594, %w_d3_l0_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv603 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad600, %w_d3_l0_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv608 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu605, %w_d3_l1_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv614 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad611, %w_d3_l1_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv619 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu616, %w_d3_l2_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv625 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad622, %w_d3_l2_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv630 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu627, %w_d3_l3_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv636 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad633, %w_d3_l3_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv641 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu638, %w_d3_l4_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv647 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad644, %w_d3_l4_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv652 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu649, %w_d3_l5_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv658 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad655, %w_d3_l5_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv663 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu660, %w_d3_l6_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv669 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad666, %w_d3_l6_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv674 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu671, %w_d3_l7_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv680 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad677, %w_d3_l7_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %init683 = tensor.empty() : tensor<1x128x7x7xf16>
  %fill684 = linalg.fill ins(%cst : f16) outs(%init683 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %conv685 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu682, %w_d3_l8_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
    outs(%fill684 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %empty686 = tensor.empty() : tensor<1x128x7x7xf16>
  %relu687 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv685 : tensor<1x128x7x7xf16>)
    outs(%empty686 : tensor<1x128x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init689 = tensor.empty() : tensor<1x32x7x7xf16>
  %fill690 = linalg.fill ins(%cst : f16) outs(%init689 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %conv691 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad688, %w_d3_l8_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
    outs(%fill690 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %empty692 = tensor.empty() : tensor<1x32x7x7xf16>
  %relu693 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv691 : tensor<1x32x7x7xf16>)
    outs(%empty692 : tensor<1x32x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x32x7x7xf16>
  %init694 = tensor.empty() : tensor<1x128x7x7xf16>
  %fill695 = linalg.fill ins(%cst : f16) outs(%init694 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %conv696 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu693, %w_d3_l9_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
    outs(%fill695 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %empty697 = tensor.empty() : tensor<1x128x7x7xf16>
  %relu698 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv696 : tensor<1x128x7x7xf16>)
    outs(%empty697 : tensor<1x128x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init700 = tensor.empty() : tensor<1x32x7x7xf16>
  %fill701 = linalg.fill ins(%cst : f16) outs(%init700 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %conv702 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad699, %w_d3_l9_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
    outs(%fill701 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %empty703 = tensor.empty() : tensor<1x32x7x7xf16>
  %relu704 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv702 : tensor<1x32x7x7xf16>)
    outs(%empty703 : tensor<1x32x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x32x7x7xf16>
  %init705 = tensor.empty() : tensor<1x128x7x7xf16>
  %fill706 = linalg.fill ins(%cst : f16) outs(%init705 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %conv707 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu704, %w_d3_l10_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
    outs(%fill706 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %empty708 = tensor.empty() : tensor<1x128x7x7xf16>
  %relu709 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv707 : tensor<1x128x7x7xf16>)
    outs(%empty708 : tensor<1x128x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init711 = tensor.empty() : tensor<1x32x7x7xf16>
  %fill712 = linalg.fill ins(%cst : f16) outs(%init711 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %conv713 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad710, %w_d3_l10_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
    outs(%fill712 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %empty714 = tensor.empty() : tensor<1x32x7x7xf16>
  %relu715 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv713 : tensor<1x32x7x7xf16>)
    outs(%empty714 : tensor<1x32x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x32x7x7xf16>
  %init716 = tensor.empty() : tensor<1x128x7x7xf16>
  %fill717 = linalg.fill ins(%cst : f16) outs(%init716 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %conv718 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu715, %w_d3_l11_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
    outs(%fill717 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %empty719 = tensor.empty() : tensor<1x128x7x7xf16>
  %relu720 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv718 : tensor<1x128x7x7xf16>)
    outs(%empty719 : tensor<1x128x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init722 = tensor.empty() : tensor<1x32x7x7xf16>
  %fill723 = linalg.fill ins(%cst : f16) outs(%init722 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %conv724 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad721, %w_d3_l11_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
    outs(%fill723 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %empty725 = tensor.empty() : tensor<1x32x7x7xf16>
  %relu726 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv724 : tensor<1x32x7x7xf16>)
    outs(%empty725 : tensor<1x32x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x32x7x7xf16>
  %init727 = tensor.empty() : tensor<1x128x7x7xf16>
  %fill728 = linalg.fill ins(%cst : f16) outs(%init727 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %conv729 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu726, %w_d3_l12_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
    outs(%fill728 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %empty730 = tensor.empty() : tensor<1x128x7x7xf16>
  %relu731 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv729 : tensor<1x128x7x7xf16>)
    outs(%empty730 : tensor<1x128x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init733 = tensor.empty() : tensor<1x32x7x7xf16>
  %fill734 = linalg.fill ins(%cst : f16) outs(%init733 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %conv735 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad732, %w_d3_l12_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
    outs(%fill734 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %empty736 = tensor.empty() : tensor<1x32x7x7xf16>
  %relu737 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv735 : tensor<1x32x7x7xf16>)
    outs(%empty736 : tensor<1x32x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x32x7x7xf16>
  %init738 = tensor.empty() : tensor<1x128x7x7xf16>
  %fill739 = linalg.fill ins(%cst : f16) outs(%init738 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %conv740 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu737, %w_d3_l13_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
    outs(%fill739 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %empty741 = tensor.empty() : tensor<1x128x7x7xf16>
  %relu742 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv740 : tensor<1x128x7x7xf16>)
    outs(%empty741 : tensor<1x128x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init744 = tensor.empty() : tensor<1x32x7x7xf16>
  %fill745 = linalg.fill ins(%cst : f16) outs(%init744 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %conv746 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad743, %w_d3_l13_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
    outs(%fill745 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %empty747 = tensor.empty() : tensor<1x32x7x7xf16>
  %relu748 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv746 : tensor<1x32x7x7xf16>)
    outs(%empty747 : tensor<1x32x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x32x7x7xf16>
  %init749 = tensor.empty() : tensor<1x128x7x7xf16>
  %fill750 = linalg.fill ins(%cst : f16) outs(%init749 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %conv751 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu748, %w_d3_l14_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
    outs(%fill750 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %empty752 = tensor.empty() : tensor<1x128x7x7xf16>
  %relu753 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv751 : tensor<1x128x7x7xf16>)
    outs(%empty752 : tensor<1x128x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init755 = tensor.empty() : tensor<1x32x7x7xf16>
  %fill756 = linalg.fill ins(%cst : f16) outs(%init755 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %conv757 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad754, %w_d3_l14_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
    outs(%fill756 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %empty758 = tensor.empty() : tensor<1x32x7x7xf16>
  %relu759 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv757 : tensor<1x32x7x7xf16>)
    outs(%empty758 : tensor<1x32x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x32x7x7xf16>
  %init760 = tensor.empty() : tensor<1x128x7x7xf16>
  %fill761 = linalg.fill ins(%cst : f16) outs(%init760 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %conv762 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu759, %w_d3_l15_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
    outs(%fill761 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %empty763 = tensor.empty() : tensor<1x128x7x7xf16>
  %relu764 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv762 : tensor<1x128x7x7xf16>)
    outs(%empty763 : tensor<1x128x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init766 = tensor.empty() : tensor<1x32x7x7xf16>
  %fill767 = linalg.fill ins(%cst : f16) outs(%init766 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %conv768 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad765, %w_d3_l15_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
    outs(%fill767 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %empty769 = tensor.empty() : tensor<1x32x7x7xf16>
  %relu770 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv768 : tensor<1x32x7x7xf16>)
    outs(%empty769 : tensor<1x32x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x32x7x7xf16>
  %init771 = tensor.empty() : tensor<1x128x7x7xf16>
  %fill772 = linalg.fill ins(%cst : f16) outs(%init771 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %conv773 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu770, %w_d3_l16_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
    outs(%fill772 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %empty774 = tensor.empty() : tensor<1x128x7x7xf16>
  %relu775 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv773 : tensor<1x128x7x7xf16>)
    outs(%empty774 : tensor<1x128x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init777 = tensor.empty() : tensor<1x32x7x7xf16>
  %fill778 = linalg.fill ins(%cst : f16) outs(%init777 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %conv779 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad776, %w_d3_l16_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
    outs(%fill778 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %empty780 = tensor.empty() : tensor<1x32x7x7xf16>
  %relu781 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv779 : tensor<1x32x7x7xf16>)
    outs(%empty780 : tensor<1x32x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x32x7x7xf16>
  %init782 = tensor.empty() : tensor<1x128x7x7xf16>
  %fill783 = linalg.fill ins(%cst : f16) outs(%init782 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %conv784 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu781, %w_d3_l17_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
    outs(%fill783 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %empty785 = tensor.empty() : tensor<1x128x7x7xf16>
  %relu786 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv784 : tensor<1x128x7x7xf16>)
    outs(%empty785 : tensor<1x128x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init788 = tensor.empty() : tensor<1x32x7x7xf16>
  %fill789 = linalg.fill ins(%cst : f16) outs(%init788 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %conv790 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad787, %w_d3_l17_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
    outs(%fill789 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %empty791 = tensor.empty() : tensor<1x32x7x7xf16>
  %relu792 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv790 : tensor<1x32x7x7xf16>)
    outs(%empty791 : tensor<1x32x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x32x7x7xf16>
  %init793 = tensor.empty() : tensor<1x128x7x7xf16>
  %fill794 = linalg.fill ins(%cst : f16) outs(%init793 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %conv795 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu792, %w_d3_l18_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
    outs(%fill794 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %empty796 = tensor.empty() : tensor<1x128x7x7xf16>
  %relu797 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv795 : tensor<1x128x7x7xf16>)
    outs(%empty796 : tensor<1x128x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init799 = tensor.empty() : tensor<1x32x7x7xf16>
  %fill800 = linalg.fill ins(%cst : f16) outs(%init799 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %conv801 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad798, %w_d3_l18_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
    outs(%fill800 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %empty802 = tensor.empty() : tensor<1x32x7x7xf16>
  %relu803 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv801 : tensor<1x32x7x7xf16>)
    outs(%empty802 : tensor<1x32x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x32x7x7xf16>
  %init804 = tensor.empty() : tensor<1x128x7x7xf16>
  %fill805 = linalg.fill ins(%cst : f16) outs(%init804 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %conv806 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu803, %w_d3_l19_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
    outs(%fill805 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %empty807 = tensor.empty() : tensor<1x128x7x7xf16>
  %relu808 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv806 : tensor<1x128x7x7xf16>)
    outs(%empty807 : tensor<1x128x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init810 = tensor.empty() : tensor<1x32x7x7xf16>
  %fill811 = linalg.fill ins(%cst : f16) outs(%init810 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %conv812 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad809, %w_d3_l19_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
    outs(%fill811 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %empty813 = tensor.empty() : tensor<1x32x7x7xf16>
  %relu814 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv812 : tensor<1x32x7x7xf16>)
    outs(%empty813 : tensor<1x32x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x32x7x7xf16>
  %init815 = tensor.empty() : tensor<1x128x7x7xf16>
  %fill816 = linalg.fill ins(%cst : f16) outs(%init815 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %conv817 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu814, %w_d3_l20_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
    outs(%fill816 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %empty818 = tensor.empty() : tensor<1x128x7x7xf16>
  %relu819 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv817 : tensor<1x128x7x7xf16>)
    outs(%empty818 : tensor<1x128x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init821 = tensor.empty() : tensor<1x32x7x7xf16>
  %fill822 = linalg.fill ins(%cst : f16) outs(%init821 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %conv823 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad820, %w_d3_l20_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
    outs(%fill822 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %empty824 = tensor.empty() : tensor<1x32x7x7xf16>
  %relu825 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv823 : tensor<1x32x7x7xf16>)
    outs(%empty824 : tensor<1x32x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x32x7x7xf16>
  %init826 = tensor.empty() : tensor<1x128x7x7xf16>
  %fill827 = linalg.fill ins(%cst : f16) outs(%init826 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %conv828 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu825, %w_d3_l21_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
    outs(%fill827 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %empty829 = tensor.empty() : tensor<1x128x7x7xf16>
  %relu830 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv828 : tensor<1x128x7x7xf16>)
    outs(%empty829 : tensor<1x128x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init832 = tensor.empty() : tensor<1x32x7x7xf16>
  %fill833 = linalg.fill ins(%cst : f16) outs(%init832 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %conv834 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad831, %w_d3_l21_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
    outs(%fill833 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %empty835 = tensor.empty() : tensor<1x32x7x7xf16>
  %relu836 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv834 : tensor<1x32x7x7xf16>)
    outs(%empty835 : tensor<1x32x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x32x7x7xf16>
  %init837 = tensor.empty() : tensor<1x128x7x7xf16>
  %fill838 = linalg.fill ins(%cst : f16) outs(%init837 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %conv839 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu836, %w_d3_l22_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
    outs(%fill838 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %empty840 = tensor.empty() : tensor<1x128x7x7xf16>
  %relu841 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv839 : tensor<1x128x7x7xf16>)
    outs(%empty840 : tensor<1x128x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init843 = tensor.empty() : tensor<1x32x7x7xf16>
  %fill844 = linalg.fill ins(%cst : f16) outs(%init843 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %conv845 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad842, %w_d3_l22_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
    outs(%fill844 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %empty846 = tensor.empty() : tensor<1x32x7x7xf16>
  %relu847 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv845 : tensor<1x32x7x7xf16>)
    outs(%empty846 : tensor<1x32x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x32x7x7xf16>
  %init848 = tensor.empty() : tensor<1x128x7x7xf16>
  %fill849 = linalg.fill ins(%cst : f16) outs(%init848 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %conv850 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu847, %w_d3_l23_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
    outs(%fill849 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %empty851 = tensor.empty() : tensor<1x128x7x7xf16>
  %relu852 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv850 : tensor<1x128x7x7xf16>)
    outs(%empty851 : tensor<1x128x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init854 = tensor.empty() : tensor<1x32x7x7xf16>
  %fill855 = linalg.fill ins(%cst : f16) outs(%init854 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %conv856 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad853, %w_d3_l23_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
    outs(%fill855 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %empty857 = tensor.empty() : tensor<1x32x7x7xf16>
  %relu858 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv856 : tensor<1x32x7x7xf16>)
    outs(%empty857 : tensor<1x32x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x32x7x7xf16>
  %init859 = tensor.empty() : tensor<1x128x7x7xf16>
  %fill860 = linalg.fill ins(%cst : f16) outs(%init859 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %conv861 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu858, %w_d3_l24_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
    outs(%fill860 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %empty862 = tensor.empty() : tensor<1x128x7x7xf16>
  %relu863 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv861 : tensor<1x128x7x7xf16>)
    outs(%empty862 : tensor<1x128x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init865 = tensor.empty() : tensor<1x32x7x7xf16>
  %fill866 = linalg.fill ins(%cst : f16) outs(%init865 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %conv867 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad864, %w_d3_l24_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
    outs(%fill866 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %empty868 = tensor.empty() : tensor<1x32x7x7xf16>
  %relu869 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv867 : tensor<1x32x7x7xf16>)
    outs(%empty868 : tensor<1x32x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x32x7x7xf16>
  %init870 = tensor.empty() : tensor<1x128x7x7xf16>
  %fill871 = linalg.fill ins(%cst : f16) outs(%init870 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %conv872 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu869, %w_d3_l25_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
    outs(%fill871 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %empty873 = tensor.empty() : tensor<1x128x7x7xf16>
  %relu874 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv872 : tensor<1x128x7x7xf16>)
    outs(%empty873 : tensor<1x128x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init876 = tensor.empty() : tensor<1x32x7x7xf16>
  %fill877 = linalg.fill ins(%cst : f16) outs(%init876 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %conv878 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad875, %w_d3_l25_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
    outs(%fill877 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %empty879 = tensor.empty() : tensor<1x32x7x7xf16>
  %relu880 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv878 : tensor<1x32x7x7xf16>)
    outs(%empty879 : tensor<1x32x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x32x7x7xf16>
  %init881 = tensor.empty() : tensor<1x128x7x7xf16>
  %fill882 = linalg.fill ins(%cst : f16) outs(%init881 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %conv883 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu880, %w_d3_l26_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
    outs(%fill882 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %empty884 = tensor.empty() : tensor<1x128x7x7xf16>
  %relu885 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv883 : tensor<1x128x7x7xf16>)
    outs(%empty884 : tensor<1x128x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init887 = tensor.empty() : tensor<1x32x7x7xf16>
  %fill888 = linalg.fill ins(%cst : f16) outs(%init887 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %conv889 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad886, %w_d3_l26_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
    outs(%fill888 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %empty890 = tensor.empty() : tensor<1x32x7x7xf16>
  %relu891 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv889 : tensor<1x32x7x7xf16>)
    outs(%empty890 : tensor<1x32x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x32x7x7xf16>
  %init892 = tensor.empty() : tensor<1x128x7x7xf16>
  %fill893 = linalg.fill ins(%cst : f16) outs(%init892 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %conv894 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu891, %w_d3_l27_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
    outs(%fill893 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %empty895 = tensor.empty() : tensor<1x128x7x7xf16>
  %relu896 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv894 : tensor<1x128x7x7xf16>)
    outs(%empty895 : tensor<1x128x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init898 = tensor.empty() : tensor<1x32x7x7xf16>
  %fill899 = linalg.fill ins(%cst : f16) outs(%init898 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %conv900 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad897, %w_d3_l27_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
    outs(%fill899 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %empty901 = tensor.empty() : tensor<1x32x7x7xf16>
  %relu902 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv900 : tensor<1x32x7x7xf16>)
    outs(%empty901 : tensor<1x32x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x32x7x7xf16>
  %init903 = tensor.empty() : tensor<1x128x7x7xf16>
  %fill904 = linalg.fill ins(%cst : f16) outs(%init903 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %conv905 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu902, %w_d3_l28_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
    outs(%fill904 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %empty906 = tensor.empty() : tensor<1x128x7x7xf16>
  %relu907 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv905 : tensor<1x128x7x7xf16>)
    outs(%empty906 : tensor<1x128x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init909 = tensor.empty() : tensor<1x32x7x7xf16>
  %fill910 = linalg.fill ins(%cst : f16) outs(%init909 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %conv911 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad908, %w_d3_l28_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
    outs(%fill910 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %empty912 = tensor.empty() : tensor<1x32x7x7xf16>
  %relu913 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv911 : tensor<1x32x7x7xf16>)
    outs(%empty912 : tensor<1x32x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x32x7x7xf16>
  %init914 = tensor.empty() : tensor<1x128x7x7xf16>
  %fill915 = linalg.fill ins(%cst : f16) outs(%init914 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %conv916 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu913, %w_d3_l29_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
    outs(%fill915 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %empty917 = tensor.empty() : tensor<1x128x7x7xf16>
  %relu918 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv916 : tensor<1x128x7x7xf16>)
    outs(%empty917 : tensor<1x128x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init920 = tensor.empty() : tensor<1x32x7x7xf16>
  %fill921 = linalg.fill ins(%cst : f16) outs(%init920 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %conv922 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad919, %w_d3_l29_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
    outs(%fill921 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %empty923 = tensor.empty() : tensor<1x32x7x7xf16>
  %relu924 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv922 : tensor<1x32x7x7xf16>)
    outs(%empty923 : tensor<1x32x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x32x7x7xf16>
  %init925 = tensor.empty() : tensor<1x128x7x7xf16>
  %fill926 = linalg.fill ins(%cst : f16) outs(%init925 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %conv927 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu924, %w_d3_l30_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
    outs(%fill926 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %empty928 = tensor.empty() : tensor<1x128x7x7xf16>
  %relu929 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv927 : tensor<1x128x7x7xf16>)
    outs(%empty928 : tensor<1x128x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %init931 = tensor.empty() : tensor<1x32x7x7xf16>
  %fill932 = linalg.fill ins(%cst : f16) outs(%init931 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %conv933 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad930, %w_d3_l30_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
    outs(%fill932 : tensor<1x32x7x7xf16>) -> tensor<1x32x7x7xf16>
  %empty934 = tensor.empty() : tensor<1x32x7x7xf16>
  %relu935 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv933 : tensor<1x32x7x7xf16>)
    outs(%empty934 : tensor<1x32x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  } -> tensor<1x32x7x7xf16>
  %init936 = tensor.empty() : tensor<1x128x7x7xf16>
  %fill937 = linalg.fill ins(%cst : f16) outs(%init936 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %conv938 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu935, %w_d3_l31_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
    outs(%fill937 : tensor<1x128x7x7xf16>) -> tensor<1x128x7x7xf16>
  %empty939 = tensor.empty() : tensor<1x128x7x7xf16>
  %relu940 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv938 : tensor<1x128x7x7xf16>)
    outs(%empty939 : tensor<1x128x7x7xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %conv944 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad941, %w_d3_l31_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  // FC: 1x1 conv 32->1000
  %init947 = tensor.empty() : tensor<1x1000x7x7xf16>
  %fill948 = linalg.fill ins(%cst : f16) outs(%init947 : tensor<1x1000x7x7xf16>) -> tensor<1x1000x7x7xf16>
  %conv949 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu946, %w_fc : tensor<1x32x7x7xf16>, tensor<1000x32x1x1xf16>)
    outs(%fill948 : tensor<1x1000x7x7xf16>) -> tensor<1x1000x7x7xf16>
  return %conv949 : tensor<1x1000x7x7xf16>
}
