func.func @densenet201(
  ...
  %init760 = tensor.empty() : tensor<1x32x14x14xf16>
  %fill761 = linalg.fill ins(%cst : f16) outs(%init760 : tensor<1x32x14x14xf16>) -> tensor<1x32x14x14xf16>
  %conv762 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu759, %w_t2_conv : tensor<1x32x14x14xf16>, tensor<32x32x1x1xf16>)
    outs(%fill761 : tensor<1x32x14x14xf16>) -> tensor<1x32x14x14xf16>
  %empty763 = tensor.empty() : tensor<1x32x14x14xf16>
  %relu764 = linalg.generic {
    indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                     affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
    iterator_types = ["parallel", "parallel", "parallel", "parallel"]
  } ins(%conv762 : tensor<1x32x14x14xf16>)
    outs(%empty763 : tensor<1x32x14x14xf16>) {
  ^bb0(%in: f16, %out: f16):
    %z = arith.constant 0.0 : f16
    %m = arith.maximumf %in, %z : f16
    linalg.yield %m : f16
  ...
  %conv768 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<2> : tensor<2xi64>
  } ins(%pad765, %w_t2_pool : tensor<1x32x16x16xf16>, tensor<32x32x3x3xf16>)
  ...
  %conv773 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu770, %w_d3_l0_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv779 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad776, %w_d3_l0_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv784 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu781, %w_d3_l1_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv790 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad787, %w_d3_l1_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv795 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu792, %w_d3_l2_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv801 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad798, %w_d3_l2_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv806 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu803, %w_d3_l3_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv812 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad809, %w_d3_l3_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv817 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu814, %w_d3_l4_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv823 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad820, %w_d3_l4_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv828 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu825, %w_d3_l5_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv834 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad831, %w_d3_l5_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv839 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu836, %w_d3_l6_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv845 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad842, %w_d3_l6_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv850 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu847, %w_d3_l7_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv856 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad853, %w_d3_l7_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv861 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu858, %w_d3_l8_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv867 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad864, %w_d3_l8_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv872 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu869, %w_d3_l9_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv878 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad875, %w_d3_l9_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv883 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu880, %w_d3_l10_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv889 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad886, %w_d3_l10_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv894 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu891, %w_d3_l11_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv900 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad897, %w_d3_l11_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv905 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu902, %w_d3_l12_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv911 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad908, %w_d3_l12_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv916 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu913, %w_d3_l13_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv922 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad919, %w_d3_l13_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv927 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu924, %w_d3_l14_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv933 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad930, %w_d3_l14_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv938 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu935, %w_d3_l15_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv944 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad941, %w_d3_l15_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv949 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu946, %w_d3_l16_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv955 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad952, %w_d3_l16_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv960 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu957, %w_d3_l17_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv966 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad963, %w_d3_l17_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv971 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu968, %w_d3_l18_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv977 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad974, %w_d3_l18_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv982 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu979, %w_d3_l19_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv988 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad985, %w_d3_l19_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv993 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu990, %w_d3_l20_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv999 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad996, %w_d3_l20_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv1004 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu1001, %w_d3_l21_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv1010 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad1007, %w_d3_l21_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv1015 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu1012, %w_d3_l22_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv1021 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad1018, %w_d3_l22_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv1026 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu1023, %w_d3_l23_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv1032 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad1029, %w_d3_l23_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv1037 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu1034, %w_d3_l24_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv1043 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad1040, %w_d3_l24_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv1048 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu1045, %w_d3_l25_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv1054 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad1051, %w_d3_l25_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv1059 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu1056, %w_d3_l26_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv1065 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad1062, %w_d3_l26_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv1070 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu1067, %w_d3_l27_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv1076 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad1073, %w_d3_l27_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv1081 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu1078, %w_d3_l28_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv1087 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad1084, %w_d3_l28_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv1092 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu1089, %w_d3_l29_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv1098 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad1095, %w_d3_l29_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv1103 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu1100, %w_d3_l30_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv1109 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad1106, %w_d3_l30_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  %conv1114 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu1111, %w_d3_l31_bn : tensor<1x32x7x7xf16>, tensor<128x32x1x1xf16>)
  ...
  %conv1120 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%pad1117, %w_d3_l31_conv : tensor<1x128x9x9xf16>, tensor<32x128x3x3xf16>)
  ...
  // FC: 1x1 conv 32->1000
  %init1123 = tensor.empty() : tensor<1x1000x7x7xf16>
  %fill1124 = linalg.fill ins(%cst : f16) outs(%init1123 : tensor<1x1000x7x7xf16>) -> tensor<1x1000x7x7xf16>
  %conv1125 = linalg.conv_2d_nchw_fchw {
    dilations = dense<1> : tensor<2xi64>,
    strides = dense<1> : tensor<2xi64>
  } ins(%relu1122, %w_fc : tensor<1x32x7x7xf16>, tensor<1000x32x1x1xf16>)
    outs(%fill1124 : tensor<1x1000x7x7xf16>) -> tensor<1x1000x7x7xf16>
  return %conv1125 : tensor<1x1000x7x7xf16>
}
